...
namespace API.Migrations.Migrations
{
    ...
    [Migration("20220905111541_EditUserConfiguration2")]
    partial class EditUserConfiguration2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Domain.Entities.UserProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("API.Domain.Entities.UserProfile", b =>
                {
                    b.HasOne("API.Domain.Entities.ApplicationUser", "User")
                        .WithOne("User")
                        .HasForeignKey("API.Domain.Entities.UserProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade);
